...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <span style="background: url(view/image/payment/concordpay.svg) 0 0 no-repeat !important;">
        <img src="view/image/payment/concordpay.png" alt="ConcordPay" title="ConcordPay">
      </span>
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td>
            <select name="concordpay_status" class="form-control">
              <?php $st0 = $st1 = "";
        ...
        <tr>
          ...
          <td>
            <input type="text" name="concordpay_merchant"
        ...
        <tr>
          ...
          <td>
            <input type="text" name="concordpay_secretkey" value="<?php echo $concordpay_secretkey; ?>" class="form-control"/>
        ...
        <tr>
          ...
          <td>
            <select name="concordpay_order_status_id" class="form-control">
        ...
        <tr>
          ...
          <td>
            <select name="concordpay_order_reverse_status_id" class="form-control">
              <?php foreach ($order_statuses as $order_status) {
        ...
        <tr>
          ...
          <td>
            <select name="concordpay_currency" class="form-control">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="concordpay_approve_url" value="<?php echo $concordpay_approve_url; ?>" class="form-control"/>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="concordpay_decline_url" value="<?php echo $concordpay_decline_url; ?>" class="form-control"/>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="concordpay_cancel_url" value="<?php echo $concordpay_cancel_url; ?>" class="form-control"/>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="concordpay_callback_url" value="<?php echo $concordpay_callback_url; ?>" class="form-control"/>
        ...
        <tr>
          ...
          <td>
            <select name="concordpay_language" class="form-control">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="concordpay_sort_order" value="<?php echo $concordpay_sort_order; ?>" class="form-control"/>
