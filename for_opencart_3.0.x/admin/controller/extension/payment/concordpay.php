...
class ControllerExtensionPaymentConcordpay extends Controller
{
    ...
    /**
     * ControllerExtensionPaymentConcordpay constructor.
     *
     * @param $registry
     */
    ...
    public function index()
    {
        ...
        $arr = array(
            ...
            'payment_concordpay_currency',
            'payment_concordpay_approve_url',
            'payment_concordpay_callback_url',
            'payment_concordpay_decline_url',
            'payment_concordpay_cancel_url',
            'payment_concordpay_language',
            'payment_concordpay_status',
            'payment_concordpay_sort_order',
            'payment_concordpay_order_status_id',
            'payment_concordpay_order_reverse_status_id',
        );
    ...
    private function validate()
    {
        ...
        if (! $this->request->post['payment_concordpay_approve_url']) {
            $this->error['approve_url'] = $this->language->get('error_approve_url');
        }

        if (! $this->request->post['payment_concordpay_decline_url']) {
            $this->error['decline_url'] = $this->language->get('error_decline_url');
        }

        if (! $this->request->post['payment_concordpay_cancel_url']) {
            $this->error['cancel_url'] = $this->language->get('error_cancel_url');
        }

        if (! $this->request->post['payment_concordpay_callback_url']) {
