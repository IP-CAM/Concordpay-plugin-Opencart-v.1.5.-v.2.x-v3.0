...
class ControllerExtensionPaymentConcordpay extends Controller
{
    ...
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/extension/payment/concordpay.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/extension/payment/concordpay.tpl', $data);
        }
