...
// Help
$_['help_merchant'] = 'Выдаётся торговцу системой ConcordPay';
$_['help_secretkey'] = 'Выдаётся торговцу системой ConcordPay';
$_['help_order_status'] = '';
$_['help_order_reverse_status'] = '';
$_['help_currency'] = 'Валюта торговца';
$_['help_approve_url'] = 'По умолчанию: https://{your_site}/index.php?route=extension/payment/concordpay/approve';
$_['help_decline_url'] = 'По умолчанию: https://{your_site}/index.php?route=extension/payment/concordpay/decline';
$_['help_cancel_url'] = 'По умолчанию: https://{your_site}/index.php?route=extension/payment/concordpay/cancel';
$_['help_callback_url'] = 'По умолчанию: https://{your_site}/index.php?route=extension/payment/concordpay/callback';
