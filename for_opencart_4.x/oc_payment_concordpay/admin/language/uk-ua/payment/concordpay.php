...
// Help
$_['help_merchant'] = 'Надається торговцеві системою ConcordPay';
$_['help_secretkey'] = 'Надається торговцеві системою ConcordPay';
$_['help_order_status'] = '';
$_['help_order_reverse_status'] = '';
$_['help_currency'] = 'Валюта торговця';
$_['help_approve_url'] = 'Якщо не вказано: https://{your_site}/index.php?route=extension/payment/concordpay/approve';
$_['help_decline_url'] = 'За замовчуванням: https://{your_site}/index.php?route=extension/payment/concordpay/decline';
$_['help_cancel_url'] = 'За замовчуванням: https://{your_site}/index.php?route=extension/payment/concordpay/cancel';
$_['help_callback_url'] = 'За замовчуванням: https://{your_site}/index.php?route=extension/payment/concordpay/callback';
